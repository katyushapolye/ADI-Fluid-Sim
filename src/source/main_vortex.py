...
with open("Error/Linear/error_linear_re{}.csv".format(RE), 'a') as file:
    file.write(f'{N},{max(error)}\n')
#
with open("Error/Linear/errorGrad.csv", 'a') as file:
    file.write(f'{N},{max(gradError)}\n')
with open("Error/Linear/errorPressure.csv", 'a') as file:
